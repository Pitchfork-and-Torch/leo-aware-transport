...
| `zhao_zenodo23` CSV | 5 calendar-quantile Zhao/Pan IRTT+iperf3 Cubic slices | same bars; cubic-gp oracle is a **lower bound** | v3.12 research ingest (PR #12, still open). **Not** product. Do not use for dual-gate ACCEPT. |
